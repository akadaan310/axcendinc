...
const navItems = [
  { label: 'Capabilities', panel: 'capabilities' as MegaMenuPanel, href: '/capabilities' },
  ...
  return (
    <>
      <nav
        ...
        style={{
          height: '72px',
          background: scrolled || activePanel ? 'rgba(5, 5, 15, 0.92)' : 'transparent',
          backdropFilter: scrolled || activePanel ? 'blur(20px) saturate(180%)' : 'none',
          WebkitBackdropFilter: scrolled || activePanel ? 'blur(20px) saturate(180%)' : 'none',
          borderBottom: scrolled || activePanel ? '1px solid rgba(255,255,255,0.06)' : '1px solid transparent',
        }}
      >
