      ...
      >
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div ref={heroRef as React.RefObject<HTMLDivElement>}>
            ...
            >
              Axcend holds multiple federal contract vehicles allowing agencies to place task orders quickly, bypassing the overhead of full open-market competitions.
            </p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                >
                  ...
                  >
                    The GSA 8(a) STARS III GWAC provides federal agencies a pre-vetted pool of qualified IT contractors, reducing acquisition timelines while satisfying small business set-asides across a $50 billion+ IDIQ ceiling.
                  </p>
          ...
          <RevealSection delay={0}>
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                SeaPort-NxG is the Navy's primary contract vehicle covering all Naval System Commands, providing a streamlined mechanism for awarding technical task orders.
              </p>
          ...
          <RevealSection delay={80}>
            ...
            >
              ...
              <p
                ...
                style={{ color: 'var(--text-secondary)' }}
              >
                MCTSSA provides access to technical support for Marine Corps tactical environments. Axcend offers direct support to programs requiring expert infrastructure integration.
              </p>
              <ul className="space-y-1.5">
                {[
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <p
                    ...
                    style={{ color: 'var(--text-secondary)' }}
                  >
                    Partner with Axcend on large prime contracts requiring 8(a) depth, cybersecurity specialization, or cloud migration expertise. Our STARS III vehicle and federal past performance make us a credible teaming partner.
                  </p>
                  <p
                    className="text-xl font-medium leading-relaxed"
                    style={{ color: 'var(--text-secondary)' }}
                  >
                    We bring genuine technical depth. Discover a subcontractor who can actually perform before your next proposal deadline.
                  </p>
                </div>
